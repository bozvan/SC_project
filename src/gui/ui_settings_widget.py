...
"}")
    ...
    def retranslateUi(self, SettingsWidget):
        ...
        self.theme_combo.setItemText(0, _translate("SettingsWidget", "🌓 Системная"))
        self.theme_combo.setItemText(1, _translate("SettingsWidget", "☀️ Светлая"))
        self.theme_combo.setItemText(2, _translate("SettingsWidget", "🌙 Темная"))
